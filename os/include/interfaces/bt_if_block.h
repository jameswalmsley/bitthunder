...
typedef struct _BT_IF_BLOCK {
	BT_u32		(*pfnReadBlocks)	(BT_HANDLE hBlock, BT_ul32 ulBlock, BT_u32 ulCount, void *pBuffer, BT_ERROR *pError);
	BT_u32		(*pfnWriteBlocks)	(BT_HANDLE hBlock, BT_ul32 ulBlock, BT_u32 ulCount, void *pBuffer, BT_ERROR *pError);
