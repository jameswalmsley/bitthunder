...
#define ZYNQ_SLCR_CLK_CTRL_DIVISOR 			0x00001F00
...
#define ZYNQ_SLCR_CLK_CTRL_SRCSEL_DDRPLL	0x3
	...
	BT_STRUCT_RESERVED_u32(2, 0x1A0, 0x1C4);

	BT_u32	CLK_621_TRUE;

	BT_STRUCT_RESERVED_u32(3, 0x1C4, 0x200);
...
#define ZYNQ_SLCR_BOOT_MODE_IO_PLL_BYPASS		0x00000008
#define ZYNQ_SLCR_BOOT_MODE_BOOT_MODE 			0x0000000F


	BT_STRUCT_RESERVED_u32(4, 0x25C, 0x300);

	BT_u32	APU_CTRL;
	BT_u32	WDT_CLK_SEL;

	BT_STRUCT_RESERVED_u32(5, 0x304, 0x500);

	BT_u32	PSS_IDCODE;

	BT_STRUCT_RESERVED_u32(6, 0x530, 0x600);

	BT_u32	DDR_URGENT;

	BT_STRUCT_RESERVED_u32(7, 0x600, 0x60C);
	...
	BT_STRUCT_RESERVED_u32(8, 0x620, 0x700);
	...
	BT_STRUCT_RESERVED_u32(9, 0x7D4, 0x800);
	...
	BT_STRUCT_RESERVED_u32(10, 0x810, 0x830);

	BT_u32	SD0_WP_CD_SEL;
	BT_u32	SD1_WP_CD_SEL;

	BT_STRUCT_RESERVED_u32(11, 0x834, 0x900);

	BT_u32	LVL_SHFTR_EN;

	BT_STRUCT_RESERVED_u32(12, 0x900, 0x910);

	BT_u32	OCM_CFG;

	BT_STRUCT_RESERVED_u32(13, 0x910, 0xB00);
	...
	BT_STRUCT_RESERVED_u32(14, 0xB18, 0xB40);
