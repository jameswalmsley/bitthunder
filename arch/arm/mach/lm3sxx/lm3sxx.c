...
static void LM3Sxx_gpio_init(void) {
	...
	#else
		BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTA, 0, 1, 1, BT_FALSE, BT_FALSE);
	#endif
	...
	#else
		BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTA, 1, 1, 1, BT_FALSE, BT_FALSE);
	#endif
	...
	#else
		BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTA, 2, 1, 1, BT_FALSE, BT_FALSE);
	#endif
	...
	#else
		BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTA, 3, 1, 1, BT_FALSE, BT_FALSE);
	#endif
	...
	#else
		BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTA, 4, 1, 1, BT_FALSE, BT_FALSE);
	#endif
	...
	#else
		BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTA, 5, 1, 1, BT_FALSE, BT_FALSE);
	#endif
...
#else
	BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTB, 2, 1, 1, BT_FALSE, BT_TRUE);
#endif
...
#else
	BT_LM3Sxx_SetIOConfig(LM3Sxx_PORTB, 3, 1, 1, BT_FALSE, BT_TRUE);
#endif
