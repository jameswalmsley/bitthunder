...
#define LM3Sxx_RCC_RCC_OSCSRC_MAIN  		0x00000000  // MOSC
#define LM3Sxx_RCC_RCC_OSCSRC_INT   		0x00000010  // IOSC
#define LM3Sxx_RCC_RCC_OSCSRC_INT4  		0x00000020  // IOSC/4
#define LM3Sxx_RCC_RCC_OSCSRC_30    		0x00000030  // 30 kHz

#define	LM3Sxx_RCC_RCC_SYSDIV_M				0x07800000

#define LM3Sxx_RCC_RCC_SYSDIV_S     		23
#define LM3Sxx_RCC_RCC_XTAL_S       		6           // Shift to the XTAL field
#define LM3Sxx_RCC_RCC_OSCSRC_S     		4           // Shift to the OSCSRC field


	BT_u32 PLLCFG;

#define LM3Sxx_RCC_PLLCFG_OD_M     			0x0000C000  // PLL OD Value
#define LM3Sxx_RCC_PLLCFG_OD_1      		0x00000000  // Divide by 1
#define LM3Sxx_RCC_PLLCFG_OD_2      		0x00004000  // Divide by 2
#define LM3Sxx_RCC_PLLCFG_OD_4      		0x00008000  // Divide by 4
#define LM3Sxx_RCC_PLLCFG_F_M       		0x00003FE0  // PLL F Value
#define LM3Sxx_RCC_PLLCFG_R_M       		0x0000001F  // PLL R Value
#define LM3Sxx_RCC_PLLCFG_F_S       		5
#define LM3Sxx_RCC_PLLCFG_R_S       		0
...
#define LM3Sxx_RCC_RCC2_OSCSRC2_419 		0x00000060  // 4.194304 MHz
...
#define LM3Sxx_RCC_RCC2_SYSDIV2_S   		23
...
#define	LM3Sxx_RCC_RCGC_QEI0EN				0x00000100
#define	LM3Sxx_RCC_RCGC_QEI1EN				0x00000200


#define	LM3Sxx_RCC_RCGC_I2C0EN				0x00001000
#define	LM3Sxx_RCC_RCGC_I2C1EN				0X00004000
...
#define	LM3Sxx_RCC_RCGC_PORTAEN				0x00000001
#define	LM3Sxx_RCC_RCGC_PORTBEN				0x00000002
#define	LM3Sxx_RCC_RCGC_PORTCEN				0x00000004
#define	LM3Sxx_RCC_RCGC_PORTDEN				0x00000008
#define	LM3Sxx_RCC_RCGC_PORTEEN				0x00000010
#define	LM3Sxx_RCC_RCGC_PORTFEN				0x00000020
#define	LM3Sxx_RCC_RCGC_PORTGEN				0x00000040
#define	LM3Sxx_RCC_RCGC_PORTHEN				0x00000080
#define	LM3Sxx_RCC_RCGC_PORTIEN				0x00000100
#define	LM3Sxx_RCC_RCGC_PORTJEN				0x00000200
